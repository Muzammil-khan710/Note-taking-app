...
const Content = () => {
  return (
    <div className='content-container'>
        ...
        <div className='content-description'> All you need is to<Link className='link bb-2' to="/login"> Sign in</Link> or <Link className='link bb-2' to="/singup"> Create an account  </Link>.</div>
